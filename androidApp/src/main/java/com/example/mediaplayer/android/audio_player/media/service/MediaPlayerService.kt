...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        mediaSessionConnector = MediaSessionConnector(mediaSession).apply {
            ...
            setQueueNavigator(MediaQueueNavigation(mediaSession))
            setPlayer(exoPlayer)
        }
            ...
            if (ongoing && !isForegroundService) {
                ContextCompat.startForegroundService(
                    applicationContext, Intent(
                        applicationContext, this@MediaPlayerService.javaClass
                    )
                )
    ...
    inner class MediaQueueNavigation(mediaSessionCompat: MediaSessionCompat) :
    ...
    private fun preparePlayer(
        ...
        exoPlayer.addListener(PlayerEventListner())
    ...
    private inner class PlayerEventListner : Player.Listener {
